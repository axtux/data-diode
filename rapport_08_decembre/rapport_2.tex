...
\begin{itemize}
	...
	\item{UDP server: receives the data sent from the sender, on port \textit{4242}}
...
The result was a functioning prototype of a data-diode that successfully implemented the goals of this project, as well as the risk countermeasures that were specified in the document.

...
We simulate a client initiating a connection to the \textit{sender}, from the outside network, by using a binding between port 80 from the sender container, and port 8881 from the host machine (in this case, the host machine is the laptop computer running docker).\\

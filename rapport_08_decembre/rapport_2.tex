...
\subsubsection{Inside application}
Our system only stores the files in a database sent through the diode. What will be done with the data is the client business. 

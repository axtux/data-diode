...
The container was based on a Ubuntu image. Moreover, in order to create a container with the appropriate capabilities, we had to install the following packages:
...
\begin{itemize}
	...
	\item{build-essential: This package installs the Make automation tool}
\end{itemize}

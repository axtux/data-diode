...
%\begin{table}
%\lstinputlisting[firstline=1, lastline=28]{code/fiber_optic_cut.sh}
%\caption{fiber\_optic\_cut.sh : This command virtually cuts the connection %between the \textit{receiver} and the \textit{sender}, by dropping all paquets %going to the receiver.}
%\end{table}
